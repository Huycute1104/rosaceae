...
//        urlReturn += VNPAYConfig.vnp_ReturnUrl;
    ...
    public void refund(RefundRequest refundRequest, HttpServletRequest req) throws ServletException, IOException {
        ...
        String vnp_TmnCode = VNPAYConfig.vnp_TmnCode;
        String vnp_TransactionType = refundRequest.getTranstype();
        String vnp_TxnRef = refundRequest.getOrder_id();
        long amount = Integer.parseInt(refundRequest.getAmount());
        ...
        String vnp_TransactionDate = String.valueOf(refundRequest.getTrans_date());
